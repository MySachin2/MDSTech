        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... pars) {
                ...
                try {
                    ...
                    String URL="http://socket-nirvana666.rhcloud.com/auth";
                    /*String uri = Uri.parse(URL)
                            .buildUpon()
                            .appendQueryParameter("main_id", jsonObject.getString("main_id"))
                            .appendQueryParameter("uuid", jsonObject.getString("uuid"))
                            .appendQueryParameter("sub_id", sub_id)
                            .appendQueryParameter("data", data)
                            .build().toString();*/
                    Log.d("URL",URL);
                    params.add("main_id",jsonObject.getString("main_id"));
                    params.add("uuid",jsonObject.getString("uuid"));
